...
**What I did:**
- Anthropic integration in `src/lib/anthropic.ts` with templated `buildFallbackSummary` for missing-key and API-error paths. Documented exact prompt + fallback in `PROMPTS.md`.
