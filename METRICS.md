...
- **AI fallback rate** = % of audits where the summary came from the template, not Claude. Spike above ~5% = Anthropic API health issue.
...
|--------|-----------|--------|
| `POST /api/audit` p95 latency | < 3s | Investigate Anthropic call timing |
