...
|------|-------|-----------------|
| `tests/unit/audit-engine.test.ts` | 20 | UNIT-001, UNIT-002, UNIT-003, P2 engine rules |
| `tests/unit/pricing.test.ts` | 4 | pricing freshness |
...
| `tests/e2e/mobile-landing.spec.ts` | P4 mobile coverage panel |
